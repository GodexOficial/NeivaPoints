...
export const translations = {
  en: {
    ...
    'classes.addPointsToAll': 'Give XP to All',
    'classes.bulkPointsTitle': 'Give XP to the Entire Class',
    'classes.bulkPointsDesc': 'This will add the selected XP to all {count} students and record an individual history entry for each one.',
    'classes.bulkPointsStudents': 'students',
    'classes.bulkPointsSubmit': 'Give {amount} XP to {count} Students',
    'classes.bulkPointsSaving': 'Giving XP...',
    'classes.bulkPointsNoStudents': 'There are no students in this class.',
    'classes.bulkPointsError': 'Could not give XP to the class.',
  ...
  pt: {
    ...
    'classes.addPointsToAll': 'Dar XP para Todos',
    'classes.bulkPointsTitle': 'Dar XP para a Turma Inteira',
    'classes.bulkPointsDesc': 'Isso adicionará o XP escolhido aos {count} alunos e registrará um histórico individual para cada um.',
    'classes.bulkPointsStudents': 'alunos',
    'classes.bulkPointsSubmit': 'Dar {amount} XP para {count} Alunos',
    'classes.bulkPointsSaving': 'Entregando XP...',
    'classes.bulkPointsNoStudents': 'Não há alunos nesta turma.',
    'classes.bulkPointsError': 'Não foi possível dar XP para a turma.',
