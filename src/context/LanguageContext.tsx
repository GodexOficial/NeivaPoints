...
export const translations = {
  en: {
    ...
    // Rewards
    'rewards.managementTitle': 'Reward Management',
    'rewards.managementSubtitle': 'Create and maintain reward periods without changing the XP rules.',
    'rewards.calendarTitle': 'Rewards Calendar',
    'rewards.calendarSubtitle': 'Current, upcoming and completed reward periods.',
    'rewards.name': 'Reward name',
    'rewards.namePlaceholder': 'e.g. Chocolate',
    'rewards.category': 'Category',
    'rewards.categoryPlaceholder': 'e.g. Monthly, Digital, Special',
    'rewards.image': 'Image URL',
    'rewards.imagePlaceholder': 'https://.../reward-image.jpg',
    'rewards.imageHelp': 'Use a public image URL or a path from the public folder.',
    'rewards.imageUpload': 'Upload file',
    'rewards.imageUrl': 'Image URL',
    'rewards.imageChoose': 'Choose an image file (PNG, JPG, WEBP or GIF)',
    'rewards.imagePreview': 'Image preview',
    'rewards.imageInvalid': 'Choose a valid image file.',
    'rewards.imageTooLarge': 'The image must be at most 1.5 MB.',
    'rewards.imageReadError': 'Could not read the selected image.',
    'rewards.cycleType': 'Cycle type',
    'rewards.monthly': 'Monthly',
    'rewards.special': 'Special / Annual',
    'rewards.startDate': 'Start date',
    'rewards.endDate': 'End date',
    'rewards.quantity': 'Available quantity',
    ...
    'rewards.eligibility': 'Eligibility rules',
    'rewards.eligibilityPlaceholder': 'Describe who can receive it and under which conditions.',
    'rewards.create': 'Create reward',
    'rewards.update': 'Save changes',
    'rewards.saving': 'Saving...',
    'rewards.loading': 'Loading rewards...',
    'rewards.empty': 'No rewards registered yet.',
    'rewards.saved': 'Reward saved successfully.',
    'rewards.statusUpdated': 'Reward status updated.',
    'rewards.archived': 'Reward archived. Its history was preserved.',
    'rewards.saveError': 'Could not save the reward.',
    'rewards.loadError': 'Could not load rewards.',
    'rewards.edit': 'Edit reward',
    'rewards.toggle': 'Activate or deactivate reward',
    'rewards.archive': 'Archive reward',
    'rewards.archiveTitle': 'Archive reward',
    'rewards.archiveMessage': 'Archive this reward?',
    'rewards.archiveDescription': 'It will no longer be active, but its period and history will remain available.',
    'rewards.available': 'available',
    'rewards.noDescription': 'No description.',
    'rewards.noCategory': 'Reward',
    'rewards.current': 'Current',
    'rewards.upcoming': 'Upcoming',
    'rewards.ended': 'Ended',
    'rewards.currentSection': 'Current period',
    'rewards.upcomingSection': 'Upcoming',
    'rewards.endedSection': 'History',
    'rewards.noCurrent': 'There is no active reward today.',
    'rewards.noUpcoming': 'No upcoming rewards.',
    'rewards.noEnded': 'No completed periods yet.',
  ...
  pt: {
    ...
    // Rewards
    'rewards.managementTitle': 'Gerenciamento de Recompensas',
    'rewards.managementSubtitle': 'Cadastre e mantenha períodos de recompensa sem alterar as regras de XP.',
    'rewards.calendarTitle': 'Calendário de Recompensas',
    'rewards.calendarSubtitle': 'Períodos atuais, próximos e encerrados.',
    'rewards.name': 'Nome da recompensa',
    'rewards.namePlaceholder': 'ex.: Chocolate',
    'rewards.category': 'Categoria',
    'rewards.categoryPlaceholder': 'ex.: Mensal, Digital, Especial',
    'rewards.image': 'Imagem da recompensa',
    'rewards.imagePlaceholder': 'https://.../imagem-da-recompensa.jpg',
    'rewards.imageHelp': 'Use uma URL pública ou um caminho de imagem da pasta public.',
    'rewards.imageUpload': 'Enviar arquivo',
    'rewards.imageUrl': 'URL da imagem',
    'rewards.imageChoose': 'Escolha uma imagem (PNG, JPG, WEBP ou GIF)',
    'rewards.imagePreview': 'Prévia da imagem',
    'rewards.imageInvalid': 'Escolha um arquivo de imagem válido.',
    'rewards.imageTooLarge': 'A imagem deve ter no máximo 1,5 MB.',
    'rewards.imageReadError': 'Não foi possível ler a imagem escolhida.',
    'rewards.cycleType': 'Tipo de ciclo',
    'rewards.monthly': 'Mensal',
    'rewards.special': 'Especial / Anual',
    'rewards.startDate': 'Data de início',
    'rewards.endDate': 'Data de encerramento',
    'rewards.quantity': 'Quantidade disponível',
    'rewards.unlimited': 'Ilimitada',
    'rewards.status': 'Status',
    'rewards.active': 'Ativa',
    'rewards.inactive': 'Inativa',
    'rewards.description': 'Descrição',
    'rewards.eligibility': 'Regras de elegibilidade',
    'rewards.eligibilityPlaceholder': 'Descreva quem pode receber e em quais condições.',
    'rewards.create': 'Criar recompensa',
    'rewards.update': 'Salvar alterações',
    'rewards.saving': 'Salvando...',
    'rewards.loading': 'Carregando recompensas...',
    'rewards.empty': 'Nenhuma recompensa cadastrada ainda.',
    'rewards.saved': 'Recompensa salva com sucesso.',
    'rewards.statusUpdated': 'Status da recompensa atualizado.',
    'rewards.archived': 'Recompensa desativada. O histórico foi preservado.',
    'rewards.saveError': 'Não foi possível salvar a recompensa.',
    'rewards.loadError': 'Não foi possível carregar as recompensas.',
    'rewards.edit': 'Editar recompensa',
    'rewards.toggle': 'Ativar ou desativar recompensa',
    'rewards.archive': 'Desativar recompensa',
    'rewards.archiveTitle': 'Desativar recompensa',
    'rewards.archiveMessage': 'Desativar esta recompensa?',
    'rewards.archiveDescription': 'Ela não ficará mais ativa, mas seu período e histórico continuarão disponíveis.',
    'rewards.available': 'disponíveis',
    'rewards.noDescription': 'Sem descrição.',
    'rewards.noCategory': 'Recompensa',
    'rewards.current': 'Atual',
    'rewards.upcoming': 'Próxima',
    'rewards.ended': 'Encerrada',
    'rewards.currentSection': 'Período atual',
    'rewards.upcomingSection': 'Próximas',
    'rewards.endedSection': 'Histórico',
    'rewards.noCurrent': 'Não há recompensa ativa hoje.',
    'rewards.noUpcoming': 'Não há próximas recompensas.',
    'rewards.noEnded': 'Ainda não há períodos encerrados.',
